...
#    formula_errors[0] = np.sqrt((clth_bin[0]*clth_bin[0]+clth_bin[0]*clth_bin[0])/(2*ellval+1)/dell/fsky)
 ...
 #   formula_errors[3] = np.sqrt((clth_bin[3]*clth_bin[3]+clth_bin[0]*clth_bin[1])/(2*ellval+1)/dell/fsky)
    formula_errors[0] = np.sqrt((clth_bin[4]*clth_bin[2])/(2*ellval+1)/dell/fsky)
